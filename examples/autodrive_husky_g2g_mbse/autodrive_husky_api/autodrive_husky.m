...
% Reset API variables
autodrive.husky_1.id = uint16(1);
autodrive.husky_1.throttle = double(0.0);
autodrive.husky_1.differential = double(0.0);
autodrive.husky_1.encoder_ticks = int32([0; 0]);
autodrive.husky_1.encoder_angles = double([0; 0]);
autodrive.husky_1.position = double([5; 5; 0.4]);
autodrive.husky_1.orientation_quaternion = double([0; 0; 0.5; 0.8660254]);
autodrive.husky_1.orientation_euler_angles = double([0; 0; 1.0471976]);
autodrive.husky_1.angular_velocity = double([0; 0; 0]);
autodrive.husky_1.linear_acceleration = double([0; 0; 0]);
autodrive.husky_1.lidar_pointcloud = single(zeros(57600,3));
autodrive.husky_1.camera_image = uint8(zeros(720,1280,3));
% Reset output port data
block.OutputPort(1).Data = uint16(1);
block.OutputPort(2).Data = double(0.0);
block.OutputPort(3).Data = double(0.0);
block.OutputPort(4).Data = int32([0; 0]);
block.OutputPort(5).Data = double([0; 0]);
block.OutputPort(6).Data = double([0; 0; 0]);
block.OutputPort(7).Data = double([0; 0; 0; 0]);
block.OutputPort(8).Data = double([0; 0; 0]);
block.OutputPort(9).Data = double([0; 0; 0]);
block.OutputPort(10).Data = double([0; 0; 0]);
% block.OutputPort(11).Data = single(zeros(57600,3));
block.OutputPort(12).Data = uint8(zeros(720,1280,3));
% Launch a simulator instance
system('start /B "AutoDRIVE" "autodrive_husky_sim\AutoDRIVE Simulator.exe"');
