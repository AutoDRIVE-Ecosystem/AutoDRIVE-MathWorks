...
<p align="justify">
This directory hosts various turnkey demos for modular as well as end-to-end autonomous driving algorithms developed using AutoDRIVE Ecosystem and MathWorks tool suite.
</p>

![](autodrive_rzr_aeb_mbd/autodrive_rzr_aeb_mbd.gif)
