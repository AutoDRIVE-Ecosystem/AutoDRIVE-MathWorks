classdef server_hunter < WebSocketServer & handle
    % AutoDRIVE Hunter SE Server
    ...
    methods
        function obj = server_hunter(varargin)
            % Constructor
    ...
    methods (Access = protected)
        ...
        function onTextMessage(obj,conn,message)
            ...
            % Parse incoming data
            obj.hunter_1.parse_data(in_data);            
            % Encode outgoing data as a JSON message
            out_data = obj.hunter_1.generate_commands();
